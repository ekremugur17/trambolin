...
export const lineChartData = {
  labels: ['Ekrem', 'Cem', 'Cihan', 'Özge', 'Atahan', 'Tamer', 'Begüm'],
  datasets: [
    {
      label: '',
...
export const areaChartData = {
  labels: ['Ekrem', 'Cem', 'Cihan', 'Özge', 'Atahan', 'Mert', 'Begüm'],
  datasets: [
    {
      label: '',
      data: [54, 63, 60, 65, 60, 68, 60],
...
export const doughnutChartData = {
  labels: ['Giyim', 'Eğlence', 'Ev'],
  datasets: [
    {
      label: '',
      borderColor: [colors.themeColor3, colors.themeColor6, colors.themeColor1],
      backgroundColor: [
        colors.themeColor3_10,
